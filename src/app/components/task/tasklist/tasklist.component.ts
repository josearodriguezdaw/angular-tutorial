...
export class TasklistComponent implements OnInit{
  ...
  ngOnInit(): void {
    ...
    let task2:Task = new Task (2,"Tarea 2", "Descripción Tarea 2",TaskPriority.Alta,TaskStatus.EnProgreso,new Date("11/5/2024"),new Date("11/16/2024"),false);
    let task3:Task = new Task (3,"Tarea 3", "Descripción Tarea 3",TaskPriority.Baja,TaskStatus.EnProgreso,new Date("11/21/2024"),new Date("11/30/2024"),false);
